...
const validationsForm = (form) => {
  ...
  if (!form.Fecha) {
    errors.Fecha = "Debe seleccionar la fecha";
    errors.error = true;
  }
  if (!form.Descripcion) {
...
export const AhoProductoLog = () => {
  ...
  const initialForm = {
    ...
    IndicadorPermiteRetiro: "",
    IndicadorCapitazable: "",
    CodigoPeriodicidad: 0,
    DivisorInteres: "",
    MultiplicadorInteres: "",
    IndicadorPenalizaRetiroAnticipado: "",
    IndicadorPermiteBloqueado: "",
    IndicadorLiquidasSoloInteres: "",
    IndicadorGeneraContrato: "",
    IndicadorRevolutivo: "",
    PermanenciaAnnos: "",
    FechaCreacion: "",
    FechaLiquidacion: "",    
        ...
        <Paper elevation={3} className={styles.paper}>
          <Box container sx={{ maxWidth: "100%", "& button": { m: 1 } }}>
            <Grid container spacing={2} justifyContent="center" pl={5} pr={5}>
              ...
              {/* Este componente es visual por lo tanto solo tiene la opcion de regresar */}
              <Grid item xs={12} container justifyContent="end">
                <Button
                  color="secondary"
                  variant="contained"
                  onClick={() => {
                    usehistory.push(`./AhoProductoLogView`);
                  }}
                >
                  Regresar
                </Button>
