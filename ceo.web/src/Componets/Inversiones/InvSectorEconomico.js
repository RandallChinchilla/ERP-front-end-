...
const columns = [
  ...
  { id: "CodigoSector", label: "Código Sector", minWidth: 100 },
  { id: "Descripcion", label: "Descripción", minWidth: 100 }
];

const InvSectorEconomico = () => {
  ...
  const [columns, setColumns] = useState([
    ...
    { title: "Código Sector", field: "CodigoSector" },
    { title: "Descripción", field: "Descripcion" },
  ]);

  const { Data, Error, setData } = useGetData("InvTipo/GetInvTipos");
  console.log(Data);
  ...
  return (
    <div>
      <MaterialTable
        title=" Catálogo Sector Económico"
        columns={columns}
        data={Data}
        options={{
          rowStyle: {
...
export default InvSectorEconomico;