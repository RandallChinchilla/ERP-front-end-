import {
  ...
  const columns = [
    ...
    { id: "codigoMoneda", label: "Código Moneda", minWidth: 100 },
    { id: "codigoTipoCuenta", label: "Código Tipo Cuenta", minWidth: 100 },
    { id: "descripcion", label: "Descripción", minWidth: 100 },
  ];
  
  
  const ConTipoCuentaView = () => {
                  ...
                  <TableRow key={row.codigoMarca}>
                    ...
                    <NavLink tag={Link} to="/Dashboard/ParMoneda">
                      ...
                      />
                        ...
                        <NavLink tag={Link} to="/Dashboard/ConTipoCuenta">
                      <Delete
                    ...
                    <TableCell>{row.codigoMoneda}</TableCell>
  ...
  export default ConTipoCuentaView;