import {
  ...
  const columns = [
    ...
    { id: "mascaraDeCuenta", label: "Máscara de Cuenta", minWidth: 100 },
    { id: "nivelMoneda", label: "Nivel Moneda", minWidth: 100 },
  ];
  
  const ConParametrosView = () => {
              ...
              <TableBody>
                {Data.map((row) => (
                  <TableRow key={row.codigoMarca}>
                    <TableCell>
                    <NavLink tag={Link} to="/Dashboard/ConParametros">
                      <Edit
                    ...
                    <TableCell>{row.mascaraDeCuenta}</TableCell>
                    <TableCell>{row.nivelMoneda}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
  ...
  export default ConParametrosView;