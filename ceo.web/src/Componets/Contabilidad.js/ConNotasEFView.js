import {
  ...
  const columns = [
    ...
    { id: "Consecutivo", label: "Consecutivo", minWidth: 100 },
  ];
  
  
  const ConNotasEFView = () => {
    ...
    const { Data, Error, setData } = useGetData("ConNotaEstadoFinanciero");
              ...
              <TableHead>
                <TableRow>
                  <TableCell align="center" colSpan={12}>
                    Catálogo Notas Estado Financiero
                  </TableCell>
                </TableRow>
                <TableRow>
                  {columns.map((column) => (
              ...
              <TableBody>
                {Data.map((row) => (
                  <TableRow key={row.codigoMarca}>
                    <TableCell>
                    <NavLink tag={Link} to="/Dashboard/ConNotasEF">
                      <Edit
                    ...
                    <TableCell>{row.numeroCuenta}</TableCell>
