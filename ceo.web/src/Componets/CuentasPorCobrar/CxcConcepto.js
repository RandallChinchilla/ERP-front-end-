...
const columns = [
  ...
  { id: "codigoConcepto", label: "Código Concepto", minWidth: 100 },
...
const CxcConcepto = () => {
  ...
  const [columns, setColumns] = useState([
    ...
    { title: "Código Concepto", field: "CodigoConcepto" },
    { title: "Descripción", field: "Descripcion" },
  ]);

  const { Data, Error, setData } = useGetData("CxcConcepto/GetCxcConceptos");
  console.log(Data);
  ...
  return (
    <div>
      <MaterialTable
        title=" Catálogo Concepto Cuentas Por Cobrar"
        columns={columns}
        data={Data}
        options={{
          rowStyle: {
