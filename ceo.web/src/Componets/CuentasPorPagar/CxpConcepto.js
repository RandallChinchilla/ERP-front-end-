...
const CxpConcepto = () => {
  ...
  const { Data, Error, setData } = useGetData("CxpConcepto/GetCxpConceptos");
  console.log(Data);
  ...
  return (
    <div>
      <MaterialTable
        title=" Catálogo Concepto Cuentas Por Pagar"
        columns={columns}
        data={Data}
        options={{
          rowStyle: {
