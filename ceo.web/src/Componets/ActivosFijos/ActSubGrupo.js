import {
  ...
  const columns = [
    ...
    { id: "subgrupo", label: "Sub Grupo", minWidth: 100 },
  ...
  const ActSubGrupoView = () => {
    ...
    const { Data, Error, setData } = useGetData("ActSubGrupo");
              ...
              <TableBody>
                {Data.map((row) => (
                  <TableRow key={row.codigoMarca}>
                    ...
                    <TableCell>{row.codigoGrupo}</TableCell>
                    <TableCell>{row.codigoSubGrupo}</TableCell>
