import {
  ...
  const columns = [
    ...
    { id: "codigoactivo", label: "Código Activo", minWidth: 100 },
    { id: "fechahora", label: "Fecha y Hora", minWidth: 100 },
    { id: "nombreDocumento", label: "Nombre Documento", minWidth: 100 },
  ];
  ...
  const ActDocumentoView = () => {
    ...
    const { Data, Error, setData } = useGetData("ActDocumento");
              ...
              <TableBody>
                {Data.map((row) => (
                  <TableRow key={row.codigoMarca}>
                    ...
                    <TableCell>{row.codigoActivo}</TableCell>
