import {
  ...
  const ActFormaDepreciacinView = () => {
    ...
    const { Data, Error, setData } = useGetData("ActFormaDepreciacion");
              ...
              <TableBody>
                {Data.map((row) => (
                  <TableRow key={row.codigoMarca}>
                    ...
                    <TableCell>{row.codigoFormaDepreciacion}</TableCell>
  ...
  export default ActFormaDepreciacinView;