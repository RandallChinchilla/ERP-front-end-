...
const columns = [
  ...
  { id: "CodigoTipoTasa", label: "Código Tipo Tasa", minWidth: 100 },
...
const RegTipoTasa = () => {
  ...
  const [columns, setColumns] = useState([
    ...
    { title: "Código Tipo Tasa", field: "CodigoTipoTasa" },
    { title: "Descripción", field: "Descripcion" },
  ]);

  const { Data, Error, setData } = useGetData("RegTipoTasa/GetRegTiposTasa");
  console.log(Data);
